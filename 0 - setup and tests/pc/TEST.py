...
class gui:
    def __init__(self, master):
        self.master = master
        master.title(f"LazyLists [SETUP TEST]")
        ...
        self.status_title = Label(height=1, text="CAN YOU SEE THIS CAT?", font="Consolas 12 italic")
        self.status_title.pack(fill="both", side="top")

        self.status_added = Label(height=1, text="CONGRATULATIONS", font="Consolas 12 bold", fg="green")
